...
public class MaxConfigureActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data = new Data(this,Constants.MAX_DATA);
    }
    ...
    public void onFABClick() {
        AppWidgetManager appWidgetManager = AppWidgetManager.getInstance(MaxConfigureActivity.this);
        Util.updateMaxAppWidget(MaxConfigureActivity.this,appWidgetManager,mAppWidgetId);
